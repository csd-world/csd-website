<template>
  <ValidationProvider 
    ...
    <textarea v-model="inputValue" :name="name" rows="5" class="bg-gray-100 rounded-lg outline-none border-2 border-gray-100 focus:border-primary text-sm  text-gray-700 pl-2 pt-2"></textarea>
...
export default class BaseInput extends Vue {
  ...
  @VModel({ type: String }) private inputValue!: string
}
</script>