<template>
  <div class="flex flex-col sm:flex-row  relative">
    ...
    <HeroText
      title="一群充满创造力的人"
      content="软件部汇聚了一群精通技术又充满创造力的人，他们在自己专注的方向上大放异彩。我们的很多已经毕业学长乃至现任部员都参与过各种大大小小的技术比赛，拿过各种奖项，更有着进入互联网大厂的学长作为经验和榜样。在软件部，有学分绩优异的保研卷王，有从小就钻研技术的技术大牛。在学习技术的路上大家互帮互助，精进技术。"
    />
  </div>
</template>
